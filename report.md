...
- qwen-asr latest in this full cross-implementation run: `9ecde04`.
- Current dedicated qwen-asr benchmark after the `7934c1b` merge: 437 ms offline / 64.53x RTF.
...
|---|---:|---:|---:|---:|---:|
| qwen-asr (latest full comparison) | `9ecde04` | `470` | `469` | `465` | `60.06x` |
...
|---|---:|---:|---:|---:|---:|
| qwen-asr (latest full comparison) | `9ecde04` | `859` | `896` | `851` | `32.83x` |
...
- In the latest full cross-implementation run, qwen-asr `9ecde04` is `3.43x` the speed of qwen-asr first `bf52daf`.
- In the latest full cross-implementation run, qwen-asr `9ecde04` is `3.43x` faster than the upstream pure C implementation.
- In the latest full cross-implementation run, qwen-asr `9ecde04` is `2.84x` faster than second-state MLX GPU by inference latency.
- In the latest full cross-implementation run, qwen-asr `9ecde04` is `1.44x` faster than mlx-audio Python MLX by inference latency.
